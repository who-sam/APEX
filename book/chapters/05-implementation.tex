...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{F5.5_grader-flowchart}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{F5.6_mcq-decision}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{F5.7_finalize-attempt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{F5.12_exam-take-state}
